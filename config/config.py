...
BOT_TOKEN = getenv("BOT_TOKEN",5963011012:AAFSUAj8unpoW6JvqIEK0ogjYS55ARDITX4)

# Database to save your chats and stats... Get MongoDB:-  https://telegra.ph/How-To-get-Mongodb-URI-04-06
MONGO_DB_URI = getenv("MONGO_DB_URI", mongodb+srv://TITAN:<password>@cluster0.xud0wjz.mongodb.net/?retryWrites=true&w=majority)
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001655673425"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("F4R_MUSIC_BOT")
...
GITHUB_REPO = getenv("GITHUB_REPO", https://github.com/brokenstan039/F4R-MUSIC-BOT)
